...
| Aspect | Detail |
|--------|--------|
| **Mô tả** | Gửi Push Notification đến Caregiver khi hệ thống tạo báo cáo định kỳ mới cho Patient |
| **Trigger** | Hệ thống auto-generate báo cáo ngày/tuần/tháng |
| **Recipients** | Tất cả Caregivers đang kết nối với Patient VÀ có Permission #1 = ON |
| **Content** | "[Danh xưng Patient] có báo cáo [loại] mới" |
| **Action** | Deep link đến chi tiết báo cáo |
