...
| v3.0 | 2026-02-06 | BA Team | **Relationship Direction (ONE-WAY):** (1) A1.1, B1.1: Làm rõ câu hỏi thu thập mối quan hệ "Người này là gì của bạn?", (2) BR-030: Chỉ thu thập relationship theo hướng Patient-to-Caregiver, (3) BR-031: ZNS template caregiver_to_patient dùng "Người thân {Tên}" thay vì {Mối quan hệ} |
